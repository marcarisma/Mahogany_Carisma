...
After the user has entered the coordinates, it will then calculate the distance between two ponts. For example, the coordinates are 2, 3, 7, 8. The answer will be 7.071.
